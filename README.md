...
### Overview
 This is a React-based Google Books Search app. It uses React components, along with helper/util functions, and utilize React lifecycle methods to query and display books based on user searches. 
 The app also use Node, Express and MongoDB so that users can save books to review or purchase later.
